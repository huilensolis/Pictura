...
export function ProfileConfigTheme() {
  ...
  return (
    <div className="flex gap-2 justify-center items-center">
      <button
        className={`py-16 px-32 flex justify-center items-center bg-neutral-800 rounded-xl border-2 border-transparent dark:border-blue-500 focus:outline-none`}
      ...
      <button
        className={`py-16 px-32 flex justify-center items-center bg-neutral-50 rounded-xl border-2 dark:border-transparent border-blue-500 focus:outline-none`}
