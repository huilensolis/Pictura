    ...
    <div className="py-10 flex flex-col gap-4">
      ...
      <form className="flex gap-2 w-full" onSubmit={handleSubmit(publishPost)}>
        <section className="flex flex-col gap-4">
          <div
            className="flex cursor-pointer h-full max-h-[700px] w-96 relative flex-col justify-center items-center bg-neutral-300 hover:bg-neutral-300 dark:hover:bg-cm-lighter-gray rounded-md overflow-hidden"
        ...
        <section className="flex flex-col gap-4">
          <div className="flex flex-col">
            <textarea
              placeholder="Title"
              className="bg-transparent placeholder:font-bold text-4xl w-full max-w-96 h-[340px] border border-neutral-300 resize-none p-2 text-neutral-800 dark:text-neutral-300 font-bold placeholder:text-neutral-400 dark:placeholder:text-neutral-500 focus:outline-none"
              {...register("title", {
                maxLength: {
                  value: 150,
